...
public class ConnectFourMain extends JFrame implements ActionListener
{
	...
	public ConnectFourMain()
	{
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage("sovietIcon.png"));
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		else if (event.getSource() == rulesMenuItem) // Selected "Rules"
		{
			JOptionPane
					.showMessageDialog(
							this,
							"Player's turn is indicated by the top image."
									+ "\n\nPlayer selects a column by clicking "
									+ "the\nmouse or by pressing the arrow keys"
									+ "\nand/or Enter key.\n\nFirst player to get"
									+ " 4-in-a-row in any direction wins. "
									+ "\n\nGood luck!",
							"Rules",
